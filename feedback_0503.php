    ...
    <div class="container">
        ...
        <div class="form-area">
            ...
            <div class="form-group" style="margin-bottom:20px" id="interestDiv">
                ...
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;"><input
                            type="radio" name="testDrive" id="testDrive" value="yes" onClick="edValueKeyPress()"/>
                    Yes</label>
                <label style="font-size: 18px;font-weight: lighter;"><input type="radio" name="testDrive" id="testDrive"
                                                                            value="no" onClick="edValueKeyPress()"/> No</label>
