...
echo "https://meo.co.in/MessagingAPI/sendMessage.php?LoginId=9833696603&password=amit@6804&mobile_number=".$usermobile."&message=http://www.shobiztech.com/toyota/img/whatapp_sl.jpg";*/
 ...
 $baseurl = "https://meo.co.in/MessagingAPI/sendMessage.php";
		...
		$params2 = array("command"=>"createcustomer", "LoginId"=>$username, "password"=>$pw, 
        "mobile_number"=>$usermobile,"message"=>'For any queries, please contact: 09833696603');
        $link2 = $baseurl . '?' . http_build_query($params2);
             ...
             //print $content;
			  ...
			  $ch2 = curl_init();              
             // Set query data here with the URL
             curl_setopt($ch2, CURLOPT_URL, $link2);
			 curl_setopt($ch2, CURLOPT_RETURNTRANSFER, 1);
             curl_setopt($ch2, CURLOPT_TIMEOUT, '3');
             $content2 = trim(curl_exec($ch2));
             curl_close($ch2);
