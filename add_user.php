                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                $sql = $db->query( "SELECT cu.crew_users_id,cu.full_name,cu.email_id,cu.mobile,cu.password,cu.location_id,lm.location_name,cu.status FROM `crew_users` AS cu JOIN location_m AS lm ON cu.location_id = lm.location_id;" );
