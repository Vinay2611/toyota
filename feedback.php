    ...
    <div class="container">
        ...
        <div style="text-align:center">
            ...
            <small style="margin-top:20px; margin-left:20px; text-transfor:uppercase">
                <strong><?= $_SESSION['location_name']; ?>  - <a href="logout.php">Logout</a></strong>
            </small>
        </div>
        <div class="form-area">
            <div class="form-group">
                <span class="req">*</span><label class="blue-bg">Name:</label>
                <input class="form-field" name="name" id="username" onKeyPress="edValueKeyPress()" onKeyUp="edValueKeyPress()" style="width:83%"/>
            </div>
            <div class="form-group">
                ...
                <br><label id="mobileno-validate" class="error" for="mobileno" style="display: none;"></label>
            </div>
            <div class="form-group">
                <span class="req">*</span>
                <label class="blue-bg">Email ID:</label>
                <input class="form-field" name="email" id="email" onKeyPress="edValueKeyPress()" onKeyUp="edValueKeyPress()" style="width:83%"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <span class="req" style="top:12px">*</span> <label class="blue-bg" style="width:25%">
                    Occupation:</label>
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;">
                    <input
                            type="radio" name="occupation" id="occupation" value="Business"
                            onClick="edValueKeyPress()"/> Business</label>
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;"><input
                            type="radio" name="occupation" id="occupation" value="Service" onClick="edValueKeyPress()"/>
                    Service</label>
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;"><input
                            type="radio" name="occupation" id="occupation" value="Others" onClick="edValueKeyPress()"/>
                    Others</label>

            </div>

            <div class="form-group" style="margin-bottom:20px" id="own-car">
                <span class="req" style="top:12px">*</span> <label class="blue-bg" style="width:25%"> Do you own a
                    car?:</label>
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;"><input
                            type="radio" name="r21" id="r21" value="yes" onClick="edValueKeyPress()"/> Yes</label>
                <label style="font-size: 18px;font-weight: lighter;"><input type="radio" name="r21" id="r21" value="no"
                                                                            onClick="edValueKeyPress()"/> No</label>
            </div>
                    ...
                    <div class="brand-wrapper">
                        <div class="brand-block">
                            ...
                            <div id="demoForm" style="display:flex">
                                <div class="form-group" style="width: 200px;float: left;"><span class="req"
                                                                                                style="position: relative;top: 2px;margin-left: 30px;left: -10px;">*</span>
                                    <select name="brand1" id="brand1" onChange="getcarmodels1(this.value)">
                                        <option value="">Brand</option>
                                        <?php
                                        $sql = "SELECT * FROM `brands_m`";
                                        $que = $db->query( $sql );
                                        while($row = $que->fetch_assoc()) {
                                        ?>
                  ...
                  <option value="">Car Model</option>
                        ...
                        <div class="brand-block" style="display:none">
                            ...
                            <div id="demoForm" style="display:flex">
                                <div class="form-group">
                                    <span class="req"
                                          style="position: relative;top: 2px;margin-left: 30px;left: -10px;opacity: 0">*</span>
                                ...
                                <div class="form-group"><span class="req"
                                                              style="position: relative;top: 2px;margin-left: 30px;left: -10px; opacity: 0">*</span>
            ...
            <div class="form-group" style="margin-bottom:20px" id="interestDiv">
                <span class="req" style="top:12px">*</span> <label class="blue-bg" style="width:25%"> Would you be
                    interested in test drive?:</label>
                <label style="margin-left: 20px;margin-top: 15px;margin-right: 20px;font-size: 18px;font-weight: lighter;">
                    <input type="radio" name="testDrive" id="testDrive" value="yes" onClick="edValueKeyPress()"/>
                    Yes</label>
                <label style="font-size: 18px;font-weight: lighter;">
                    <input type="radio" name="testDrive" id="testDrive" value="no" onClick="edValueKeyPress()"/> No</label>

                <div id="test-driveDiv" style="display: none;margin-top: 18px">
                    <div class="form-group" id="current-own">
                        <label class="blue-bg" style="margin-right:0px; float: left;width: 25%">Driving Licence No:</label>
                        <div class="brand-wrapper">
                            <div class="brand-block">
                                <div id="demoForm" style="display:flex">
                                    <div class="form-group" style="width: 200px;float: left;">
                                        <!--<span class="req" style="position: relative;top: 2px;margin-left: 30px;left: -10px;">*</span>-->
                                        <input type="text" class="form-field" name="dl_no" id="dl_no" style="width: 100%;" onClick="edValueKeyPress()" value="">
                                    </div>
                                    <div class="form-group" style="width: 200px;float: left;">
                                        <!--<span class="req" style="position: relative;top: 2px;margin-left: 30px;left: -10px;">*</span> -->
                                        <span id="carmodel1"><!--<input type="file" name="image" id="image" accept="image/*"
                                                                     capture="environment" onClick="edValueKeyPress()">--></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="form-group" style="margin-bottom:20px">
                <span class="req" style="top:4px">*</span> <strong style="font-size: 22px; margin-bottom:10px">Next car
                    purchase plan:</strong>

                <label style="font-size: 18px;font-weight: lighter; margin-right:20px;  white-space:nowrap"><input
                            type="radio" name="r0" id="1" value="Within 3 months" onClick="edValueKeyPress()"/> Within 3
                    months</label>
                <label style="font-size: 18px;font-weight: lighter; margin-right:20px;  white-space:nowrap"><input
                            type="radio" name="r0" id="2" value="3 - 6 months" onClick="edValueKeyPress()"/> 3 - 6
                    months</label>
                <label style="font-size: 18px;font-weight: lighter; margin-right:20px;  white-space:nowrap"><input
                            type="radio" name="r0" id="3" value="6 months to 1 year" onClick="edValueKeyPress()"/> 6
                    months to 1 year</label>
                <label style="font-size: 18px;font-weight: lighter; margin-right:20px;  white-space:nowrap"><input
                            type="radio" name="r0" id="4" value="No current plan" onClick="edValueKeyPress()"/> No
                    current plan</label>
            </div>
            <div class="form-group" style="margin-top:20px"><span class="req">*</span>
                ...
                <span id="citytd" style="width:70%">
                    <select name="city" id="city" onchange="edValueKeyPress();">
            ...
            <div class="form-group">
                <span class="req" style="top:2px">*</span> <label>
                    <input type="checkbox" name="agree"/> I Agree to the</label>
                <a href="terms-and-conditions.php" target="_new">Terms & Conditions</a>
        ...
        <div style="float: right;">
            <a href="driving_licence.php">click here to upload driving licence</a>
        </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <a href="#" style="float: right;" data-dismiss="modal" class="btn btn-sm btn-default">Edit <i
                            class="fa fa-pencil" style="    margin-left: 6px;margin-top: 2px;"></i></a>
                <h4 class="modal-title">Preview</h4>
            </div>
            <form id="mainformtable" method="post" name="mainformtable" enctype="multipart/form-data">
...
" name="emmail" id="emmail" readonly></textarea></td>
                        ...
                        <tr>
                            ...
                            <td id="yescar" style="display:none">
                                <table style="table-layout: fixed;" class="table table-bordered">
                                    <tr>
                                        <td id=""><input type="text" name="brand11" id="brand11" readonly></td>
                                        <td id=""><input type="text" name="car11" id="car11" readonly></td>

                                        <td id=""><input type="text" name="yr11" id="yr11" readonly></td>
                                    </tr>
                                    ...
                                    <tr id="td13" style="display:none">
                                        ...
                                        <td id=""><input type="text" name="yr13" id="yr13" readonly></td>
                                    </tr>
                        ...
                        <tr>
                            <th>Dealer</th>
                            <td id="" style="width:100%;"><input type="text" name="ccity" id="ccity" readonly
                                                                 style="width:100%;"></td>
                        </tr>
                        <tr>
                            <th>Driving Licence</th>
                            <td id="" style="width:100%;"><input type="text" name="ddlno" id="ddlno" readonly
                                                                 style="width:100%;"></td>
                        </tr>
                        <tr>
                            <th>RC Book</th>
                            <td id="" style="width:100%;">
                                <input type="file" name="rrcbook" id="rrcbook" value="" accept="image/*" capture="environment"></td>
                        </tr>
                    ...
                    <div class=" text-center">
                        <input class="blue-bg" style="font-size: 18px !important;background: #ec5964 !important;padding: 13px 33px !important;color: #fff !important;" type="submit" name="formsubmitbutton" id="formsubmitbutton" value="Submit" >
                        <!--<input type="button" name="formsubmitbutton" id="formsubmitbutton" value="Submit" onClick="formsubmit1()">-->
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="otp-box">
                        ...
                        <p style="margin-bottom: 20px; font-size:20px">A verification code has been sent to </p>
                        <p style="font-size:17px" id="mobilenostr"><strong>+91 9876543210</strong></p>
                        <hr>
                        <label>Enter OTP</label> <input class="form-field" name="otp" id="otp">

                        <div id="otpsreseenddone" style="display:none;text-align:center"> Otp again sent successfully to
                            your mobile
                        </div>
                        <div id="seondtimer" style="display:none;text-align:center">Resend button will get active in
...
<div class="modal fade" id="thankyou" role="dialog">
    ...
    border: none;
    color: #fff;
    border:1px solid transparent;" type="button" data-dismiss="modal">Close
                    </button>
                </div>
...
<script>
    ...
    function edValueKeyPress() {
        ...
        //Show dl no rcbook
        var dlValue = document.getElementById("dl_no");
        document.getElementById('ddlno').value = dlValue.value;

        //var imageValue = document.getElementById("image");
        //alert(imageValue);
        //document.getElementById('rrcbook').value = imageValue.value;

        $('#rrcbook').attr('src', $("#image").attr('src'));
...
<script>
    ...
    $("#mainformtable").on('submit',(function(e) {
        e.preventDefault();
    ...
    function formsubmit12() {
        ...
        $.ajax({
            url: "feedback_process.php", // Url to which the request is send
    ...
    function getcitywithstate(id) {
        edValueKeyPress();
        //alert(id);
        $.post("ajaxcall/getcitylist.php", {id: id}, function (response) {
            $("#city").html(response);
            //alert(response);
        });
    }
    ...
    /*Validate phone number from ajax request*/
    $("#mobileno").blur(function() {
        //Assigning search box value to javascript variable named as "name".
        var mobilenoVal = $.trim($('#mobileno').val());
        var mobilenoLen = mobilenoVal.length;
        //console.log(mobilenoVal);
        //console.log(mobilenoLen);
        if (mobilenoLen == 10){
            //AJAX is called.
            $.ajax({
                //AJAX type is "Post".
                ...
                url: "ajaxcall/validate-mobile.php",
                ...
                success: function(html) {
                    console.log(html);
                    if(html == ''){
                        $("#mobileno").css({"border": "none"});
                    }else{
                        //Assigning result to "display" div in "search.php" file.
                        $("#mobileno").css({"border": "2px solid red"});
                        $("#mobileno-validate").text(html).show();
                    }
