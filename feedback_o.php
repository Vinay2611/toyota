...
<div class="brand-block">
<div id="demoForm"  style="display:flex">
<div class="form-group" style="width: 200px;float: left;"><!--<span class="req" style="position: relative;top: 2px;margin-left: 30px;left: -10px;">*</span>--><input type="text" name="dl_no" id="dl_no" onClick="edValueKeyPress()"  value="">
</div>
<div class="form-group" style="width: 200px;float: left;"> <!--<span class="req" style="position: relative;top: 2px;margin-left: 30px;left: -10px;">*</span> --><span id="carmodel1"><input type="file" name="image" accept="image/*" capture="environment" onClick="edValueKeyPress()"></span> </div>
</div>
</div>
</div>
</div>
                     ...
                     <table style="table-layout: fixed;" class="table table-bordered">
                      ...
                      <tr>
                        <th>Driving Licence</th>
                          <td id="" style="width:100%;"><input type="text" name="ddlno" id="ddlno" readonly style="width:100%;">    </td>
                      </tr>
                       <tr>
                        <th>RC Book</th>
                          <td id="" style="width:100%;"><input type="file" name="rrcbook" id="rrcbook" accept="image/*" capture="environment">  </td>
                      </tr>
