...
<div style="text-align:center">
    ...
    <small style="margin-top:20px; margin-left:20px; text-transfor:uppercase"><strong>Kolkata - South City Mall</strong></small>
</div>	
<div class="form-area">
...
<small style="margin-top: 5px;color: #696565;position: absolute;left: 68%;top: 7px;">(OTP WILL BE SENT TO THIS NUMBER )</small>
</div>
<div class="form-group">
...
<!--    <span>City</span>&nbsp;-->
    ...
    <option value="">City</option>
   	 <option value="8">AHMEDABAD</option>
								 ...
								 <option value="15">Trivandrum</option>
...
" name="emmail" id="emmail" readonly></textarea></td>
                  ...
                  <input type="hidden" name="useridnew" id="useridnew" value="40" >
                  <input type="hidden" name="locationnew" id="locationnew" value="1">
              </tbody>
          </table>
...
$select7.on( 'change', function() {
 ...
 var xmlHttpReq = false;
	...
	xmlHttpReq.onreadystatechange = function()
	 ...
	 xmlHttpReq.open('GET','admin/ajaxCallToPhp/getcitylist.php?id='+id, true);
...
{edValueKeyPress();
 ...
 var xmlHttpReq = false;
	...
	xmlHttpReq.onreadystatechange = function()
	 ...
	 xmlHttpReq.open('GET','admin/ajaxCallToPhp/getcarmodelid.php?id='+id, true);
	 xmlHttpReq.send(null); 	
}
